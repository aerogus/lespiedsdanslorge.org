...
La sortie du premier EP 6 titres de Prickly Pearl est prévu pour début 2017.`,
  },
  {
    ...
    twitter: '',
    description: `De la grosse disto, une touche de post rock, une pointe de jazz, Odd Fiction est un groupe de métal progressif instrumental qui brise les frontières de la musique en alliant brutal et finesse, créant une fiction pour le moins étrange.
    Cette bête hideuse, hybride musical, créé des atmosphères tantôt violentes, tantôt planante, parfois clownesque, installant dans l'espace sonore un non sens absurde, bien vite rattrapé par des grooves métal à s'en décrocher la tête.
    Mais ne fuyez pas l'antre de la bête, car c'est à l'intérieur qu'on y entend la douce musique de ses cris lugubres...`,
  },
  {
    id: 'abracadabra',
    name: 'Abracadabra',
