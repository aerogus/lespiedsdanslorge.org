module.exports = [
  {
    ...
    style: 'Pop Fr',
    description: `
Sur des mélodies pop chantées en français, Arthédone raconte des histoires du quotidien dans lesquelles apparaissent tour à tour un séducteur charmé ou un passionné qui tente de réaliser ses rêves quoi qu’il en coûte. Dans la ballade "Danse mon petit fou" transparait la tendresse d’un père pour son fils, à qui il faut expliquer l’absurdité du monde.
Dans le but de tourner partout en France, des vidéos live ont été filmées lors d'une résidence à l’Avant-Scène de Rueil - Malmaison en octobre 2017. L’année 2018 fut particulièrement riche : Arthédone participe aux 46èmes rencontres d’Astaffort (P.d’honneur : Francis Cabrel ; Parrain : Christophe Maé), joue en première partie de Princess Erika et se produit à de nombreuses reprises. La sortie d'un EP est prévu en 2019.
Des bars "underground" aux salles de spectacle, des coins du feu en solo aux concerts accompagnés de ses musiciens (Da Muss à la batterie et aux chœurs et Jules Brosset à la basse et aux chœurs), ce toulousain à Paris prend plaisir à vous en donner.
    `,
    photo: '/img/artistes/arthedone.jpg',
    video: 'https://www.youtube-nocookie.com/embed/77QDFXC5p5o',
    links: {
      site: 'https://www.arthedone.com',
